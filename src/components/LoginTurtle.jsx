...
import modelPath from '/assets/shapes-transformed.glb'
import turtleModelPath from '/assets/model_52a_-_kemps_ridley_sea_turtle_no_id-transformed.glb'

import '../turtle.css'

export default function LoginTurtle({ spheres }) {
  return (
    <Canvas
      shadows
...
function Turtle(props) {
  const { scene, animations } = useGLTF(turtleModelPath)
